...
import com.example.mrxjava.functions.Func3;
import com.example.mrxjava.functions.Func4;
import com.example.mrxjava.functions.Functions;
...
public class WatchableExtensions {
     ...
     *
     * @param <T> the type of item emitted by the Watchable
     */
     ...
     *
     * @param <T> the type of object returned by the Watchable
     */
    private static class ThrowWatchable<T> extends AbstractIObservable<T> {
         ...
         *
         * @param observer a Watcher of this Watchable
     ...
     *
     * @param <T>  the type emitted by the Watchable sequence
     * @param func a closure that accepts a <code>Watcher<T></code> and calls its <code>onNext</code>, <code>onError</code>, and <code>onCompleted</code> methods
     ...
     *
     * @param that      the Watchable to filter
     * @param predicate a closure that evaluates the items emitted by the source Watchable, returning <code>true</code> if they pass the filter
     ...
     *
     * @param value the value to pass to the Watcher's <code>onNext</code> method
     ...
     *
     * @param that the source Watchable
     ...
     *
     * @param sequence the source Watchable
     * @param func     a closure to apply to each item in the sequence emitted by the source Watchable
     * @param <T>      the type of items emitted by the the source Watchable
     * @param <R>      the type of items returned by map closure <code>func</code>
     ...
     *
     * @param sequence the source Watchable
     * @param function a closure to apply to each item in the sequence emitted by the source Watchable
     * @param <T>      the type of items emitted by the the source Watchable
     * @param <R>      the type of items returned by map closure <code>function</code>
     * @return a Watchable that is the result of applying the transformation function to each item
     * in the sequence emitted by the source Watchable
     */
     ...
     *
     * @param sequence the source Watchable
     * @param func     a closure to apply to each item emitted by the source Watchable, generating a
     *                 Watchable
     * @param <T>      the type emitted by the source Watchable
     * @param <R>      the type emitted by the Watchables emitted by <code>func</code>
     ...
     *
     * @param sequence the source Watchable
     * @param function a closure to apply to each item emitted by the source Watchable, generating a
     *                 Watchable
     * @param <T>      the type emitted by the source Watchable
     * @param <R>      the type emitted by the Watchables emitted by <code>function</code>
     * @return a Watchable that emits a sequence that is the result of applying the transformation
     ...
     *
     * @param source a list of Watchables that emit sequences of items
     ...
     * <a href="https://confluence.corp.netflix.com/plugins/gliffy/viewlargediagram.action?name=marble.merge&ceoid=27321465&key=API&pageId=27321465"><img src="https://confluence.corp.netflix.com/download/attachments/27321465/marble.merge.png"></a>
     *
     * @param source a series of Watchables that emit sequences of items
     * @return a Watchable that emits a sequence of elements that are the result of flattening the
     ...
     *
     * @param source a Watchable that emits Watchables
     * @return a Watchable that emits a sequence of elements that are the result of flattening the
     ...
     *
     * @param <T> the type of item (not) emitted by the Watchable
     ...
     *
     * @param that           the source Watchable
     * @param resumeSequence the Watchable that will take over if the source Watchable encounters an error
     ...
     *
     * @param that           the source Watchable
     * @param resumeFunction a closure that returns a Watchable that will take over if the source Watchable
     *                       encounters an error
     * @return the source Watchable, with its behavior modified as described
     */
     ...
     *
     * @param that           the source Watchable
     * @param resumeFunction a closure that returns a value that will be passed into a Watcher's <code>onNext</code> closure if the Watchable encounters an error that would
     ...
     *
     * @param <T>         the type item emitted by the source Watchable
     * @param sequence    the source Watchable
     * @param accumulator an accumulator closure to be invoked on each element from the sequence, whose
     ...
     * @param <T>          the type item emitted by the source Watchable
     * @param sequence     the source Watchable
     * @param initialValue a seed passed into the first execution of the accumulator closure
     * @param accumulator  an accumulator closure to be invoked on each element from the sequence, whose
     *                     result will be used in the next accumulator call (if applicable)
     * @return a Watchable that emits a single element that is the result of accumulating the
     * output from applying the accumulator to the sequence of items emitted by the source
     ...
     *
     * @param items the source Watchable
     ...
     *
     * @param observable the source Watchable
     * @param <T>        the type of item emitted by the source Watchable
     ...
     *
     * @param items the source Watchable
     * @param num   the number of items from the start of the sequence emitted by the source
     *              Watchable to emit
     ...
     * @param <T>      the type of items in the iterable sequence and the type emitted by the resulting
     *                 Watchable
     ...
     * src="https://confluence.corp.netflix.com/download/attachments/27321465/marble.towatchable.png"></a>
     *
     * @param iterable the source Array
     * @param <T>      the type of items in the Array, and the type of items emitted by the resulting
     *                 Watchable
     ...
     *
     * @param w0             one source Watchable
     * @param w1             another source Watchable
     * @param reduceFunction a closure that, when applied to an item emitted by each of the source Watchables,
     ...
     * @param w0       one source Watchable
     * @param w1       another source Watchable
     * @param w2       a third source Watchable
     * @param function a closure that, when applied to an item emitted by each of the source Watchables,
     *                 results in a value that will be emitted by the resulting Watchable
     * @return a Watchable that emits the zipped results
     */
     ...
     * @param w1             another source Watchable
     * @param w2             a third source Watchable
     * @param w3             a fourth source Watchable
     * @param reduceFunction a closure that, when applied to an item emitted by each of the source Watchables,
     *                       results in a value that will be emitted by the resulting Watchable
     * @return a Watchable that emits the zipped results
     */
    ...
    public static class UnitTest {
        ...
        private void runGroovyScript(String script) {
            ...
            binding.setVariable("o", WatchableExtensions.class);
